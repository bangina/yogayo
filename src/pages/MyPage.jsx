              ...
              >
                <div className={classes.imgUploadBox}>
                  ...
                  <div className={classes.inputContainer}>
                    ...
                    />
                    <label for="file" className={classes.inputFileIcon}>
                      <PhotoCameraIcon
                        color="primary"
                        className={classes.inputFileSvg}
                        fontSize="small"
                      />
                    </label>
                  </div>
                ...
                <div style={{ marginLeft: "20px" }}>
                  ...
                  <Typography gutterBottom className={classes.descText}>
                    {" "}
                    • &nbsp; 휴대폰 번호 : {userInfo.phone.slice(0, 3)}-
                    {userInfo.phone.slice(3, 7)}-{userInfo.phone.slice(7, 11)}
                  </Typography>
                </div>
              </div>
            </CardContent>
              ...
              <CardContent>
                ...
                {voucherInfo ? (
                  <>
                    <Typography
                      color="primary"
                      className={classes.voucherStatBox}
                    >
                      이용권 {voucherInfo.status ? "정상" : "사용불가"} <br />
                      (잔여횟수 {voucherInfo.limit - voucherInfo.used}회)
                    </Typography>
                    <Typography gutterBottom className={classes.voucherInfo}>
                      <PlaceIcon color="primary" className={classes.svgIcon} />{" "}
                      센터 : {voucherInfo.adminname}
                      <br />
                    ...
                    <Slider
                      ...
                      value={(voucherInfo.used / voucherInfo.limit) * 100}
                    />
                    <span style={{ paddingLeft: "10px", color: "#666" }}>
                      총 {voucherInfo.used}회 / {voucherInfo.limit}회 사용
                    </span>
                    <br />
                  </>
                ) : (
                  <>
                    ...
                    <TextField
                      ...
                      variant="outlined"
                      value={code}
                      onChange={(e) => voucherCodeChange(e)}
                    />
                    <Button
                      variant="contained"
                      color="primary"
                      ...
                      <tr className={classes.tableRow}>
                        <td>
                          <TextField
                            ...
                            placeholder="수강권 이름"
                            variant="outlined"
                            value={centerVoucherInfo.name}
                            name="name"
                            onChange={(e) => centerVoucherChange(e)}
                          />
                        </td>
                        <td>
                          <TextField
                            ...
                            placeholder="수강권 횟수"
                            variant="outlined"
                            value={centerVoucherInfo.limit}
                            name="limit"
                            onChange={(e) => centerVoucherChange(e)}
                          />
                        </td>
                        <td style={{ color: "#999", textAlign: "center" }}>
                          수강권 코드는 자동생성됩니다.
                        </td>
                        <td>
                          <Button
              ...
              <Card className={classes.root}>
                <CardContent>
                  ...
                  >
                    <table className={classes.table}>
                      <tr className={classes.tableRow}>
                        <th className={classes.tableHeading}>수업 이름</th>
                        <th className={classes.tableHeading}>강의실</th>
                        <th className={classes.tableHeading}>수업 일자</th>
                        <th className={classes.tableHeading}>수업 시작 시간</th>
                        <th className={classes.tableHeading}>정원</th>
                      </tr>
                      <tr className={classes.tableRow}>
                        <td>
                          <TextField
                            ...
                            placeholder="수업 이름"
                            variant="outlined"
                            value={centerLessonInfo.name}
                            name="name"
                            onChange={(e) => centerLessonChange(e)}
                          />
                        </td>
                        <td>
                          <TextField
                        ...
                        <td>
                          <TextField
                            ...
                            placeholder="정원"
                            variant="outlined"
                            value={centerLessonInfo.max_ppl}
                            name="max_ppl"
                            onChange={(e) => centerLessonChange(e)}
                          />
                        </td>
