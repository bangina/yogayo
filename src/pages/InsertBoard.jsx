...
const InsertBoard = (props) => {
  ...
  return (
    <>
    <Typography variant="h4" gutterBottom color="primary">게시물 작성</Typography>
    <form className={classes.root}>
      ...
      <div>
        ...
        <br/>
        <br/>
        <Typography variant="h6" gutterBottom color="primary">이미지 첨부</Typography>
        <Typography gutterBottom color="textSecondary">이미지는 총 4장까지 첨부 가능합니다.</Typography>
        <br/>
        {/* 이미지 첨부  */}
        <div className={classes.uploadContainer}>
          ...
          <div className={classes.uploadBox}>
            <label htmlFor="imgUpload1" className={classes.uploadBtn}><PhotoCameraIcon fontSize="large"/></label>
            <div className={classes.photoBox}>
              <img ref={thumbnailRef1} src="" alt="썸네일" className={classes.thumbnail}/>
            </div>
          </div>
          <input
            type="file"
          ...
          />
          <div className={classes.uploadBox}>
            <label htmlFor="imgUpload2" className={classes.uploadBtn}><PhotoCameraIcon fontSize="large"/></label>
            <div className={classes.photoBox}>
              <img ref={thumbnailRef2} src="" alt="썸네일" className={classes.thumbnail}/>
            </div>
          </div>
          <input
            type="file"
          ...
          />
          <div className={classes.uploadBox}>
            <label htmlFor="imgUpload3" className={classes.uploadBtn}><PhotoCameraIcon fontSize="large"/></label>
            <div className={classes.photoBox}>
              <img ref={thumbnailRef3} src="" alt="썸네일" className={classes.thumbnail}/>
            </div>
          </div>
          <input
            type="file"
          ...
          />
          <div className={classes.uploadBox}>
            <label htmlFor="imgUpload4" className={classes.uploadBtn}><PhotoCameraIcon fontSize="large"/></label>
            <div className={classes.photoBox}>
              <img ref={thumbnailRef4} src="" alt="썸네일" className={classes.thumbnail}/>
            </div>
          </div>
        </div>
        <br/>
