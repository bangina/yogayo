...
const Diary = (props) => {
  ...
  const onSubmit = () => {
    ...
    axios({
      method: "post",
      url: "http://api.yogayo.kr/api/diaries/",
      data: formData,
      headers: {
    ...
    <>
      ...
      >
        ...
        <div className={classes.uploadBox}>
          <label htmlFor="imgUpload" className={classes.uploadBtn}>
            <PhotoCameraIcon />
          </label>
